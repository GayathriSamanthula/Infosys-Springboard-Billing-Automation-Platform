...
from app.schemas.customer import CustomerLogin, CustomerTokenResponse, CustomerRegister
from app.services.user_service import create_user, login_user, reset_user_password
from app.services.customer_service import login_customer, register_customer
...
def customer_register(
    ...
    Returns access token + customer profile for instant login.
    """
    try:
