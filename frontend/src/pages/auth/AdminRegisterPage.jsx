        ...
        <Box component="form" onSubmit={handleRegister} noValidate>
          <Box sx={{ textAlign: 'center', mb: 3 }}>
            <Typography variant="h5" fontWeight={800} color="#0f172a" gutterBottom>
              {t('auth.adminRegisterHeader', 'Register Admin Account')}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t('auth.adminRegisterSub', 'Create a new administrator account to manage Nexora subscriptions and billing operations.')}
            </Typography>
          </Box>
          ...
          <TextField
            fullWidth
            label={t('auth.workingIdLabel', 'Working ID / Admin Employee ID')}
            value={workingId}
          ...
          <TextField
            fullWidth
            label={t('auth.adminSecretKeyLabel', 'Admin Security Key')}
            type="password"
          ...
          >
            {loading ? t('auth.creatingAdmin', 'Creating Admin Account...') : t('auth.adminRegisterHeader', 'Register Admin Account')}
          </Button>

          <Box sx={{ mt: 3, pt: 2, borderTop: '1px solid #e2e8f0', textAlign: 'center' }}>
            <Typography variant="body2" color="text.secondary">
              {t('auth.alreadyAdminAccount', 'Already have an admin account?')}{' '}
              <Link
                component="button"
                type="button"
                variant="body2"
